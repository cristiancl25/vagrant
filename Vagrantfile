...
Vagrant.configure("2") do |config|
  ...
  config.disksize.size = '100GB' # For resize needs vagrant-disksize plugin: vagrant plugin install vagrant-disksize
  ...
  config.vm.provider "virtualbox" do |vb|
    ...
    vb.gui = true
    vb.check_guest_additions = true # vagrant plugin install vagrant-vbguest
